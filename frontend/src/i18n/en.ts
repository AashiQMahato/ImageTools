...
export const en = {
    ...
    common: {
        ...
        uploadHint: "JPG, PNG, WebP or HEIC · up to 10 MB",
        download: "Download",
        original: "Original",
        before: "Before",
        after: "After",
    ...
    nav: {
        ...
        toolItems: {
            ...
            photoGenerator: { title: "Passport & MRP Photo", description: "ID photos, sized and ready to print" },
    ...
    upload: {
        wrongType: "Please choose a JPG, PNG, WebP or HEIC image.",
        converting: (format: string) => `${format} detected — converting to JPEG…`,
        conversionFailed: (format: string) => `We couldn't convert this ${format} photo. Please try a JPG or PNG instead.`,
    ...
    errors: {
        ...
        INVALID_REQUEST: "Something about that request wasn't right. Please try again.",
        INVALID_PRESET: "Choose a photo type.",
        INVALID_CROP: "That crop isn't valid. Please reset it and try again.",
        CONVERSION_FAILED: "We couldn't convert this photo. Please try a JPG or PNG instead.",
        NO_FACE: "We couldn't detect a face. Please upload a clear front-facing portrait.",
        MULTIPLE_FACES: "Multiple faces detected. Please upload a photo containing only one person.",
        FACE_DETECTION_UNAVAILABLE: "Face detection is temporarily unavailable. Please try again in a moment.",
        FILE_EXPIRED: "This photo has expired. Please create it again.",
    ...
    studio: {
        ...
        intros: {
            ...
            photoGenerator: {
                hint: "Upload a portrait — we remove the background, crop, size and check it for you. JPG, PNG, WebP or HEIC.",
                steps: ["Upload a clear, front-facing portrait.", "Choose Passport or MRP and press Create Photo.", "Check it, adjust the crop if needed, and download or print."],
            },
            retouch: {
    ...
    photo: {
        controlsLabel: "Photo settings",
        tabs: { photo: "Photo", sheet: "Print sheet" },
        typeTitle: "Photo type",
        presetNames: { passport: "Passport", mrp: "MRP" } as Record<string, string>,
        presetFullNames: { passport: "Passport Photo", mrp: "MRP Photo" } as Record<string, string>,
        spec: (size: string, dpi: number) => `${size} · ${dpi} DPI`,
        outputTitle: "You'll get",
        output: { size: "Size", resolution: "Resolution", pixels: "Pixels", format: "Format", background: "Background", white: "White" },
        pixels: (width: number, height: number) => `${width.toLocaleString("en-US")} × ${height.toLocaleString("en-US")} px`,
        create: "Create Photo",
        presetChanged: (name: string) => `Photo type changed — create your ${name} to update it.`,
        presetsFailed: "Couldn't load the photo types. Check your connection and reload the page.",
        autoNote: "Background, crop, size and resolution are all handled for you.",

        preparing: "Preparing your photo",
        steps: {
            format: { active: "Checking image format", done: "Image format checked", converted: (format: string) => `Converted from ${format}` },
            orientation: { active: "Checking orientation", done: "Orientation checked", corrected: "Image orientation corrected" },
            face: { active: "Looking for the person", done: "Person detected" },
            background: { active: "Removing background", done: "Background removed" },
            white: { active: "Creating white background", done: "White background created" },
            composition: { active: "Adjusting passport composition", done: "Composition adjusted" },
            resolution: { active: "Checking resolution", upscaling: "Enhancing image quality ×2", enhanced: "Image quality enhanced ×2", enlarged: "Image enlarged ×2", sharp: "Resolution already sharp enough" },
            finalize: { active: "Finalizing photo", done: "Photo ready" },
        },
        stages: { original: "Original", cutout: "Background removed", white: "White background" },
        ...
        checksTitle: "Photo checks",
        checks: {
            aspectRatio: "Correct shape",
            dimensions: "Exact pixel size",
            dpi: "Print resolution saved in the file",
            whiteBackground: "Plain white background",
            faceDetected: "Face detected",
            headVisible: "Whole head in the photo",
            headSize: "Head size right for ID photos",
            centered: "Face centred",
            notStretched: "Not stretched",
        } as Record<string, string>,
        fixes: {
            whiteBackground: "Something other than background reaches the edge of the photo.",
            headVisible: "Part of the head is outside the photo — zoom out or move it down.",
            headSize: "The head is too large or too small — adjust the zoom.",
            centered: "Move the photo so the face is in the middle.",
        } as Record<string, string>,
        warningsTitle: "Good to know",
        lowResLive: "Your image resolution is low. We'll upscale it before creating the final photo.",
        warnings: {
            LOW_RESOLUTION: "Your image resolution is low. We upscaled it before creating the final photo.",
            BLURRY: "The uploaded image may be too blurry for a high-quality ID photo.",
            TOO_DARK: "The face looks dark. An evenly lit photo works best.",
            TOO_BRIGHT: "The face looks overexposed. Avoid strong light or flash.",
            HEAD_TILTED: "Your head looks tilted. Official photos need it straight.",
            NOT_FACING: "Face the camera directly for official photos.",
            SMALL_FACE: "The face is small in this photo. A closer portrait gives a sharper result.",
            HEAD_AT_EDGE: "The top of the head touches the edge of your original photo and may be cut off.",
        } as Record<string, string>,

        crop: {
            title: "Adjust crop",
            hint: "Drag to move. Keep the top of the head near the upper line and the chin near the lower one.",
            zoom: "Zoom",
            ...
            applying: "Updating…",
            frame: "Photo frame",
            applied: "Crop updated.",
        },

        sheet: {
            title: "Printable sheet",
            hint: (paper: string, max: number) => `Copies of your photo on ${paper} paper, each printed at its exact size. Up to ${max} fit.`,
            copies: "Copies",
            custom: "Custom",
            customLabel: (max: number) => `Number of copies (1–${max})`,
            preparing: "Preparing the sheet…",
            preview: "Sheet preview",
            download: "Download sheet",
            needPhoto: "Create your photo first — then print as many copies as you need.",
            printTip: "Print at 100% (\"Actual size\"), not \"Fit to page\", so every photo comes out at its exact size.",
            failed: "The sheet couldn't be created. Please try again.",
        },

        failedTitle: "We couldn't create your photo",
        failed: "We couldn't create the photo from this image. Please try a clear, front-facing photo with one person.",
        expired: "This photo has expired. Please create it again.",
        cancelled: "Stopped. Create the photo whenever you're ready.",
        downloadFailed: "The download didn't work — this photo may have expired. Please create it again.",
    },
};
